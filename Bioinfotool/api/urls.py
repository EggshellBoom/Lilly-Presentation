...
from .views import CreateSequenceView, SequenceView, UpdateSequenceView, AnalyzeSequenceView, BlastSequenceView, AlignSequenceView, TreeSequenceView, BreastCancerView
